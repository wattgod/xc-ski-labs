...
def generate_profile(slug: str, race_data_dir: Path = RACE_DATA_DIR) -> str | None:
    ...
    sections.append(f"\n---\n*Generated by XC Ski Labs on {now}. Source: {SITE_URL}/race/{slug}/*\n")
...
def main() -> int:
    ...
    for slug in slugs:
        md = generate_profile(slug, data_dir)
        if md is None:
