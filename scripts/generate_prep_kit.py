...
<body>
  <nav class="pk-nav"><div class="pk-nav-inner"><a class="pk-wordmark" href="/" aria-label="XC Ski Labs"><img src="/xc-logo.svg" alt="" width="30" height="30">XC SKI <span>LABS</span></a><a href="/race/{esc(slug)}/">Race profile</a></div></nav>
