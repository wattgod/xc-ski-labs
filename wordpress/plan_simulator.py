...
.tp-sim-workout {{ --sim-kind:var(--sim-accent); width:100%; min-height:126px; display:grid; align-content:start; gap:6px; padding:8px; border:1px solid var(--sim-ink); border-top:6px solid var(--sim-kind); background:var(--sim-paper); color:var(--sim-ink); text-align:left; cursor:pointer; }} .tp-sim-workout--bike {{ --sim-kind:#7357c8; }} .tp-sim-workout--ski {{ --sim-kind:#2578a9; }} .tp-sim-workout--strength {{ --sim-kind:#c75b23; }} .tp-sim-workout--race {{ --sim-kind:#b22d2d; }} .tp-sim-workout:hover,.tp-sim-workout:focus-visible {{ outline:3px solid var(--sim-kind); outline-offset:1px; }} .tp-sim-workout-head {{ display:flex; align-items:center; justify-content:space-between; gap:4px; }} .tp-sim-workout-kind,.tp-sim-workout-structured {{ font:700 7px/1 var(--sim-data); letter-spacing:1px; text-transform:uppercase; }} .tp-sim-workout-structured {{ color:var(--sim-kind); letter-spacing:.4px; }} .tp-sim-workout-title {{ font:700 9px/1.25 var(--sim-data); }} .tp-sim-workout-meta {{ font:8px/1.2 var(--sim-data); }} .tp-sim-workout svg {{ width:100%; height:34px; border-top:1px solid var(--sim-line); border-bottom:1px solid var(--sim-line); }} .tp-sim-workout polyline {{ fill:none; stroke:var(--sim-kind); stroke-width:3; vector-effect:non-scaling-stroke; }} .tp-sim-workout .tp-sim-strength-bar {{ fill:var(--sim-kind); opacity:.82; }}
